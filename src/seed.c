...
int SEED_CBC_Encrypt(IN BYTE *pbszPlainText, IN int nPlainTextLen, OUT BYTE *pbszCipherText)
{
    BYTE pbszUserKey[16] = {0xE9, 0xF3, 0x94, 0x37, 0x0A, 0xD4, 0x05, 0x89, 0x88, 0xE3, 0x4F, 0x8F, 0x08, 0x17, 0x79, 0xF1};
    BYTE pbszIV[16] = {0x6F, 0xBA, 0xD9, 0xFA, 0x36, 0x16, 0x25, 0x01, 0x26, 0x8D, 0x66, 0xA7, 0x35, 0xA8, 0x1A, 0x81};
...
int SEED_CBC_Decrypt(IN BYTE *pbszCipherText, IN int nCipherTextLen, OUT BYTE *result)
{
    BYTE pbszUserKey[16] = {0xE9, 0xF3, 0x94, 0x37, 0x0A, 0xD4, 0x05, 0x89, 0x88, 0xE3, 0x4F, 0x8F, 0x08, 0x017, 0x79, 0xF1};
    BYTE pbszIV[16] = {0x6F, 0xBA, 0xD9, 0xFA, 0x36, 0x16, 0x25, 0x01, 0x26, 0x8D, 0x66, 0xA7, 0x35, 0xA8, 0x1A, 0x81};
